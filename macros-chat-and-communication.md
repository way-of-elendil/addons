...
{% file src=".gitbook/assets/cellular-3.3.006.zip" caption="Cellular" %}
...
{% file src=".gitbook/assets/chatmod.zip" caption="ChatMOD" %}
...
![](.gitbook/assets/636142288008973607.jpg)

{% file src=".gitbook/assets/chatter-v1.2.11-4-g76cd1e5.zip" caption="Chatter" %}
...
![](.gitbook/assets/prat-wow-classic-addon-1.13.jpg)

{% file src=".gitbook/assets/prat-3.0-3.3.26.zip" caption="Prat" %}
...
![](.gitbook/assets/wim-wow-instant-messenger-wotlk-3.3.5a-addon.jpg)

{% file src=".gitbook/assets/wim-3.3.7.zip" caption="WIM" %}
