...
{% file src=".gitbook/assets/capping-3.3.004.zip" caption="Capping Battleground Timers" %}

## Diminish \(DR Tracker\)

Indicateurs et minuteries sont mis à jour quand un CC se termine, pas lorsqu'elle est appliquée. diminish

{% file src=".gitbook/assets/diminishingreturns-v1.0-beta-12.zip" caption="Dimminish" %}
...
{% file src=".gitbook/assets/interruptbar.zip" caption="Interrupt Bar" %}
