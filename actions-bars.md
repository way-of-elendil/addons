...
{% file src=".gitbook/assets/actionbarsaver.zip" caption="ActionBarSaver" %}
...
![](.gitbook/assets/binder-scr-4.png)
...
![](.gitbook/assets/screenshot_935.png)

{% file src=".gitbook/assets/buttonfacade.zip" %}
...
![](.gitbook/assets/configuring.jpg)

{% file src=".gitbook/assets/buttonforge.zip" %}
...
![](.gitbook/assets/wowscrnshot_112014_110056.jpg)
...
![](.gitbook/assets/wowscrnshot_100211_170529.jpg)

{% file src=".gitbook/assets/chocolatebar.zip" %}
...
![](.gitbook/assets/dominos-setup.jpg)

{% file src=".gitbook/assets/dominos.zip" %}

## DragonHider

Cache le vilain dragon à gauche et à droite de votre barre d'action

![](.gitbook/assets/dragonhider-1-without-with.jpg)

{% file src=".gitbook/assets/dragonhider.zip" %}
...
![](.gitbook/assets/drd-ab.jpg)

![](.gitbook/assets/drdamage_tooltip_compact.jpg)
...
![](.gitbook/assets/farmit2-1-400x0.png)
...
![](.gitbook/assets/lsscreenshot1.jpg)
...
![](.gitbook/assets/omnicc-wow-classic-addon.png)

{% file src=".gitbook/assets/omnicc.zip" %}
...
![](.gitbook/assets/ring.jpg)

{% file src=".gitbook/assets/opie.zip" %}
